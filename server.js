...
// Serve all assets inside the public folder automatically
app.use(express.static(path.join(__dirname, 'public')));

// FIX: Explicitly send your main turf booking screen when someone visits the main link
app.get('/', (req, res) => {
...
// Path to the bookings file sitting next to server.js
...
// Helper — saves the current database to bookings.json after every booking
...
app.post('/api/payments/verify', (req, res) => {
    ...
    // Correctly compute end time for fractional durations
    ...
    // Save to disk immediately after every successful booking
    saveBookings();
